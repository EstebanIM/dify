      ...
      <div className="mx-auto mt-8 w-full">
        <div className="relative">
          <div className="rounded-lg bg-linear-to-r from-workflow-workflow-progress-bg-1 to-workflow-workflow-progress-bg-2 p-4">
            ...
            <p className="mt-1 system-xs-regular text-text-tertiary">{t('licenseLostTip', { ns: 'login', appName })}</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="mx-auto mt-8 w-full">
        <div className="relative">
          <div className="rounded-lg bg-linear-to-r from-workflow-workflow-progress-bg-1 to-workflow-workflow-progress-bg-2 p-4">
            ...
            <p className="mt-1 system-xs-regular text-text-tertiary">{t('licenseExpiredTip', { ns: 'login', appName })}</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="mx-auto mt-8 w-full">
        <div className="relative">
          <div className="rounded-lg bg-linear-to-r from-workflow-workflow-progress-bg-1 to-workflow-workflow-progress-bg-2 p-4">
            ...
            <p className="mt-1 system-xs-regular text-text-tertiary">{t('licenseInactiveTip', { ns: 'login', appName })}</p>
          </div>
        </div>
      </div>
    )
        ...
        {isInviteLink
          ...
          : (
              <div className="mx-auto w-full">
                ...
                <p className="mt-2 body-md-regular text-text-tertiary">{t('welcome', { ns: 'login', appName })}</p>
              </div>
            )}
        <div className="relative">
